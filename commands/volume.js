...
module.exports = {
  ...
  run: async function (client, message, args) {
    ...
    if (!serverQueue) return sendError("There is nothing playing in this server. You can't set volume", message.channel);
    ...
    .setAuthor("Server Volume Manager", "https://github.com/ForFightHub/Music-Bot-Discord/blob/main/assets/Music.png?raw=true")
    .setColor("BLUE")
