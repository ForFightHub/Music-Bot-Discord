	...
	run: async function (client, message, args) {
		...
		if (url.match(/^https?:\/\/(www.youtube.com|youtube.com)\/playlist(.*)$/)) {
			...
			try {
				...
				let thing = new MessageEmbed()
					.setAuthor("Playlist has been added to queue", "https://github.com/ForFightHub/Music-Bot-Discord/blob/main/assets/Music.png?raw=true")
		...
		async function handleVideo(video, message, channel, playlist = false) {
			...
			if (!serverQueue) {
				...
				if (playlist) return;
				let thing = new MessageEmbed()
					.setAuthor("Song has been added to queue", "https://github.com/ForFightHub/Music-Bot-Discord/blob/main/assets/Music.png?raw=true")
...
let thing = new MessageEmbed()
				.setAuthor("Started Playing Music!", "https://github.com/ForFightHub/Music-Bot-Discord/blob/main/assets/Music.png?raw=true")
				.setThumbnail(song.img)
				.setColor("BLUE")
				.addField("Name", song.title, true)
				.addField("Duration", song.duration, true)
